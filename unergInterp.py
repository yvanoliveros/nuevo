         ...
         for pc in range(len(self.stat)):
             ...
             if self.prog[lineno][0] == 'PARA':
                  ...
                  for i in range(pc+1,len(self.stat)):
                       ...
                       print("PARA WITHOUT NEXT AT LINE %s" % self.stat[pc])
                       self.error = 1
    ...
    def run(self):
        ...
        while 1:
            ...
            # READ statement
                 ...
                 if not self.loops:
                       print("NEXT WITHOUT PARA AT LINE %s" % line)
                       return
                 ...
                 forvar = loopinst[1]
                 if nextvar != forvar:
                       print("NEXT DOESN'T MATCH PARA AT LINE %s" % line)
                       return
                 continue
            elif op == 'GOSUB':
                 newline = instr[1]
    ...
    def list(self):
         ...
         for line in stat:
             ...
             if op in ['END','STOP','RETURN']:
                   ...
                   _out = "%s PARA %s = %s TO %s" % (line,instr[1],self.expr_str(instr[2]),self.expr_str(instr[3]))
